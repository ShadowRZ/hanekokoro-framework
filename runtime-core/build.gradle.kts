...
kotlin {
    jvm()
    android {
        namespace = "io.github.shadowrz.hanekokoro.framework.runtime.core"
...
mavenPublishing {
    ...
    coordinates(group.toString(), "runtime-core", version.toString())

    pom {
        name = "Hanekokoro Framework Runtime Core"
        description = "Core Runtime code for Hanekokoro Framework"
        inceptionYear = "2025"
