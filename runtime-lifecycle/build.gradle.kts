...
kotlin {
    android {
        namespace = "io.github.shadowrz.hanekokoro.framework.runtime.lifecycle"
    }
...
mavenPublishing {
    ...
    coordinates(group.toString(), "runtime-lifecycle", version.toString())

    pom {
        name = "Hanekokoro Framework Runtime Lifecycle"
        description = "Lifecycle Runtime code for Hanekokoro Framework"
        inceptionYear = "2025"
