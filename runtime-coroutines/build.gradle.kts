...
kotlin {
    android {
        namespace = "io.github.shadowrz.hanekokoro.framework.runtime.coroutines"
    }
...
mavenPublishing {
    ...
    coordinates(group.toString(), "runtime-coroutines", version.toString())

    pom {
        name = "Hanekokoro Framework Runtime Coroutines"
        description = "Coroutines Runtime code for Hanekokoro Framework"
        inceptionYear = "2025"
